...
QList<FilterTemplate> GraphicEQFilterGUIFactory::createFilterTemplates()
{
	...
	list.append(FilterTemplate(tr("15-band graphic equalizer"),
		"GraphicEQ: 25 0; 40 0; 63 0; 100 0; 160 0; 250 0; 400 0; 630 0; 1000 0; 1600 0; 2500 0; 4000 0; 6300 0; 10000 0; 16000 0",
		QStringList(tr("Graphic equalizers"))));
	list.append(FilterTemplate(tr("31-band graphic equalizer"),
	...
	list.append(FilterTemplate(
		tr("Graphic equalizer with variable bands"), "GraphicEQ: ", QStringList(tr("Graphic equalizers"))));
	return list;
}
